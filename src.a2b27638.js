...
function readDOMChange(view, from, to, typeOver, addedNodes) {
  ...
  })) || !$from.sameParent($to) && $from.pos < parse.doc.content.size && (nextSel = _prosemirrorState.Selection.findFrom(parse.doc.resolve($from.pos + 1), 1, true)) && nextSel.head == $to.pos) && view.someProp("handleKeyDown", function (f) {
...
editHandlers.drop = function (view, e) {
  ...
  if (view.someProp("handleDrop", function (f) {
    return f(view, e, slice || _prosemirrorModel.Slice.empty, dragging && dragging.move);
  })) {
    e.preventDefault();
    return;
  }
...
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"src/schema/index.js":[function(require,module,exports) {
"use strict";
...
exports.schema = schema;
},{"prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js"}],"node_modules/prosemirror-commands/dist/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js","prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"src/newCommands/index.js":[function(require,module,exports) {
"use strict";
...
function wrapInList(listType) {
  return function (state, dispatch) {
    ...
    var wrap = (0, _prosemirrorTransform.findWrapping)(outerRange, listType, null, range);
...
},{"prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-transform":"node_modules/prosemirror-transform/dist/index.es.js"}],"src/menu/index.js":[function(require,module,exports) {
"use strict";
...
var _newCommands = require("../newCommands");
    ...
    value: function update() {
      ...
      this.items.forEach(function (_ref3) {
        var command = _ref3.command,
            dom = _ref3.dom;
        var active = command(_this2.editorView.state, null, _this2.editorView);
...
var menu = menuPlugin([{
  command: (0, _prosemirrorCommands.toggleMark)(_schema.schema.marks.italic),
  dom: textLabel("i", "italic")
}, {
  command: (0, _prosemirrorCommands.toggleMark)(_schema.schema.marks.bold),
  dom: textLabel("b", "bold")
}, {
  command: (0, _prosemirrorCommands.wrapIn)(_schema.schema.nodes.sec),
  dom: textLabel("sec", "wrap content into section")
}, {
  command: (0, _newCommands.wrapInList)(_schema.schema.nodes.uList),
  dom: fontawesomewLabel("fas fa-list", "unordered list")
}, {
  command: (0, _newCommands.wrapInList)(_schema.schema.nodes.oList),
  dom: fontawesomewLabel("fas fa-list-ol", "ordered list")
}, {
  command: (0, _prosemirrorCommands.setBlockType)(_schema.schema.nodes.title),
  dom: textLabel("title", "title")
}, {
  command: (0, _prosemirrorCommands.setBlockType)(_schema.schema.nodes.par),
  dom: fontawesomewLabel("fas fa-paragraph", "paragraph")
}, {
  command: (0, _prosemirrorCommands.wrapIn)(_schema.schema.nodes.dispQuote),
  dom: fontawesomewLabel("fas fa-quote-right", "blockquote")
}]);
exports.menu = menu;
},{"prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-commands":"node_modules/prosemirror-commands/dist/index.es.js","../schema":"src/schema/index.js","../newCommands":"src/newCommands/index.js"}],"node_modules/w3c-keyname/index.es.js":[function(require,module,exports) {
"use strict";
...
},{"w3c-keyname":"node_modules/w3c-keyname/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js"}],"src/extKeymap/index.js":[function(require,module,exports) {
"use strict";
...
function buildKeymap(schema) {
  ...
  if (type = schema.nodes.listItem) {
    bind("Enter", (0, _newCommands.splitListItem)(type));
  }

  return keys;
}
},{"../newCommands":"src/newCommands/index.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var _extKeymap = require("./extKeymap");
...
var view = new _prosemirrorView.EditorView(editorEl, {
  state: state
});
},{"prosemirror-model":"node_modules/prosemirror-model/dist/index.es.js","prosemirror-state":"node_modules/prosemirror-state/dist/index.es.js","prosemirror-view":"node_modules/prosemirror-view/dist/index.es.js","./schema":"src/schema/index.js","./menu":"src/menu/index.js","prosemirror-keymap":"node_modules/prosemirror-keymap/dist/index.es.js","./extKeymap":"src/extKeymap/index.js","prosemirror-commands":"node_modules/prosemirror-commands/dist/index.es.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
